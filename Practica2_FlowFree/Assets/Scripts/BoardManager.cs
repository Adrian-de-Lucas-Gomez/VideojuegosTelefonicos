    ...
    public class BoardManager : MonoBehaviour
    {
        ...
        private void HandleInput()
        {
            ...
            if (IsPosInBoard(worldPos))
            {
                ...
                if (Input.GetMouseButtonDown(0)) //Si el usuario acaba de pulsar el bot�n izquierdo 
                {
                ...
                else if (Input.GetMouseButtonUp(0)) //Si el usuario acaba de liberar el bot�n izquierdo 
                {
                ...
                else if (Input.GetMouseButton(0)) //Si el usuario est� pulsando el bot�n izquierdo
                {
